      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Join Netflix and start watching unlimited movies and TV shows.
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-start">
            <input
              ...
              type="checkbox"
              required
              className="h-4 w-4 text-netflix-red focus:ring-netflix-red border-gray-700 rounded bg-gray-800 mt-1"
            />
          ...
          <div className="text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/login" className="font-medium text-netflix-red hover:text-red-400 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
